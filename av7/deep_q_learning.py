...
from keras.losses import MeanSquaredError, MSE
...
class DuelingDQN:
    ...
    def _build_model(self, layers):
        ...
        model.compile(adam_v2.Adam(lr=self.learning_rate), loss=MeanSquaredError())
        return model
...
class DDPG:
    ...
    def _build_actor(self):
        ...
        actor.compile(loss="mse", optimizer=adam_v2.Adam(lr=self.learning_rate_actor))
        return actor
    ...
    def _build_critic(self):
        ...
        critic.compile(loss="mse", optimizer=adam_v2.Adam(lr=self.learning_rate_critic))
        return critic
